declare namespace ymaps {
    ...
    namespace control {
        ...
        class TrafficControl extends Button {
    ...
    namespace util {
        ...
        namespace bounds {
            function getCenterAndZoom(bound: any, size: Array<number>): { center: Array<number>, zoom: number };
        }
    ...
    namespace geolocation {
        ...
        function get(options: { provider: string, autoReverseGeocode: boolean }): Promise<GeoLocationResult>;
    }
    ...
    class ObjectManager implements ICustomizable, IEventEmitter, IGeoObject, IParentOnMap {
        ...
        public constructor(config: ObjectManagerConfig);

        public add(objects: any): ObjectManager;

        public removeAll(): ObjectManager;

        public setFilter(cb: Function): void;

        public getOverlay(): Promise<IOverlay>;

        public getOverlaySync(): IOverlay | null;

        public getParent(): IParentOnMap | null;

        public setParent(parent: IControlParent | null): this;
    }
    ...
    class SuggestView implements ICustomizable, IEventEmitter {
        ...
        public constructor(dom: string, config: object)
    }
    ...
    function route(way: Array<string>, options: object): Promise<ymaps.Route>;

    namespace coordSystem {
        namespace geo {
            function getDistance(point1: any, point2: any): number;
        }
    }
}